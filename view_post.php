   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <div class="icons">
            ...
            <div style="display: block;"><button class = "b1" style="margin-right: 10px" type="submit" name="like_post"><i class="fas fa-thumbs-up" style="<?php if($confirm_likes->rowCount() > 0){ echo 'color:var(--red);'; } ?>  "></i><span>(<?= $total_post_likes; ?>)</span></button>
            <button class = "b1" type="submit" name="dislike_post"><i class="fas fa-thumbs-down" style="<?php if($confirm_dislikes->rowCount() > 0){ echo 'color:var(--red);'; } ?>  "></i><span>(<?= $total_post_dislikes; ?>)</span></button></div>
         </div>
